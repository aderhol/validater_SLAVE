...
build-2081044321:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-2081044321-inproc

build-2081044321-inproc: ../uartecho.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-2081044321 ../uartecho.cfg
configPkg/compiler.opt: build-2081044321
configPkg/: build-2081044321
